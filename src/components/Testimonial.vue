<template>
  ...
  <div class="container my-24 mx-auto md:px-6">
    ...
    <section class="mb-32 mx-4 sm:mx-6 md:mx-12 text-center">
          ...
          >
            ...
            <div class="p-6">
              ...
              <p class="text-ellipsis overflow-hidden line-clamp-4">
                ...
                blanditiis praesentium accusamus contestatur voluptatum deleniti
                atque corrupti.
              </p>
            </div>
          </div>
        ...
        <div class="mb-0">
          ...
          >
            ...
            <div class="p-6">
              ...
              <p class="text-ellipsis overflow-hidden line-clamp-4">
                Consectetur ex aute aute nisi commodo. Aute anim mollit ullamco
                sint adipisicing dolor. Reprehenderit cillum aliquip mollit
                dolore exercitation commodo consectetur non mollit tempor
                nostrud esse. Adipisicing proident aliquip laboris proident
                eiusmod duis cupidatat exercitation ea cillum anim tempor ad ad.
              </p>
            </div>
          </div>
        </div>
...
// If you have any script setup logic, you can add it here
</script>
